...
export function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      const user = await createUser({ email: formData.email, password: formData.password, name: formData.username})
      if (user.$id) {
        onSignupSuccess();
      }
    }
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            />
            {errors.name && (
              <p className="mt-1 font-['Lato'] text-sm" style={{ color: '#ef4444' }}>
                {errors.name}
              </p>
            )}
          </div>
            ...
            <div className="relative">
              <input
                ...
                style={{ 
                  backgroundColor: 'var(--bg-secondary)',
                  color: 'var(--text-primary)',
                  border: `2px solid ${errors.confirmPassword ? '#ef4444' : 'var(--border)'}`,
                }}
        ...
        <div className="mt-6 text-center">
          <p className="font-['Lato']" style={{ color: 'var(--text-secondary)' }}>
